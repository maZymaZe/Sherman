...
#ifdef NO_WRITE_CONFLICT
            // NO_WRITE_CONFLICT should use YCSB workload with
            // insertorder=ordered and do manual hash
...
void parse_args(int argc, char* argv[]) {
    ...
    ycsb_load_path = "../../SMART/ycsb/workloads/load_" + std::string(argv[4]) +
                     "_workload" + std::string(argv[5]);
    ycsb_trans_path = "../../SMART/ycsb/workloads/txn_" + std::string(argv[4]) +
                      "_workload" + std::string(argv[5]);
    if (argc == 7)
